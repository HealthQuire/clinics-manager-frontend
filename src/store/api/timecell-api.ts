...
console.log(
    import.meta.env.VITE_API_URL +
        "/timecell" +
        `/today/${localStorage.getItem("doctorid")}`,
);
...
export const timecellApi = createApi({
    ...
    endpoints: (builder) => ({
        ...
        postTimeCell: builder.mutation<ITimeCell, ITimeCellBody>({
        ...
        patchTimeCell: builder.mutation<
            ITimeCell,
            { update: Partial<ITimeCell>; id: string }
        >({
        ...
        deleteTimeCell: builder.mutation<ITimeCell, { id: string }>({
...
export const {
    ...
    usePatchTimeCellMutation,
    useDeleteTimeCellMutation,
